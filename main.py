...
def weixin_hook_message():
	...
	if body == 'top' or body == 't' or body == u'排名':
		return wechat.response_text(top())
	...
	response = wechat.response_text(u'新来的吧,输入"帮助" 查看指引吧')
	return response

def level_info(level):
	if level == 1:
		info = dict(name='渣渣', number_min=1, number_max=5, time_limit=10)
	elif level == 2:
		info = dict(name='青铜', number_min=5, number_max=10, time_limit=15)
	elif level == 3:
		info = dict(name='白银1', number_min=10, number_max=50, time_limit=10)
	elif level == 4:
		info = dict(name='白银2', number_min=10, number_max=50, time_limit=10)
	elif level == 5:
		info = dict(name='黄金1', number_min=50, number_max=100, time_limit=10)
	elif level == 6:
		info = dict(name='黄金2', number_min=100, number_max=500, time_limit=15)
	elif level == 7:
		info = dict(name='黄金3', number_min=500, number_max=999, time_limit=15)
	elif level == 8:
		info = dict(name='黄金4', number_min=500, number_max=999, time_limit=10)
	elif level == 9:
		info = dict(name='钻石1', number_min=1000, number_max=5000, time_limit=15)
	elif level == 10:
		info = dict(name='钻石2', number_min=5000, number_max=9999, time_limit=10)
	elif level == 11:
		info = dict(name='钻石3', number_min=10000, number_max=50000, time_limit=10)
	elif level == 12:
		info = dict(name='钻石4', number_min=50000, number_max=99999, time_limit=10)
	else:
		number_min=10**level
		number_max=10**(level+1)-1
		info = dict(name='黄金2', number_min=number_min, number_max=number_max, time_limit=15)
